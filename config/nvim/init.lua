...
wk.add({
	...
	-- Jupyter/Molten operations
	{ "<leader>j", group = "📓 Jupyter", icon = "📓" },
	{ "<leader>ji", "<cmd>MoltenInit<cr>", desc = "Initialize Molten", icon = "🚀" },
	{ "<leader>je", "<cmd>MoltenEvaluateOperator<cr>", desc = "Evaluate Operator", icon = "▶️" },
	{ "<leader>jl", "<cmd>MoltenEvaluateLine<cr>", desc = "Evaluate Line", icon = "▶️" },
	{ "<leader>jr", "<cmd>MoltenReevaluateCell<cr>", desc = "Re-evaluate Cell", icon = "🔄" },
	{ "<leader>jd", "<cmd>MoltenDelete<cr>", desc = "Delete Cell", icon = "🗑️" },
	{ "<leader>jo", "<cmd>MoltenShowOutput<cr>", desc = "Show Output", icon = "👁️" },
	{ "<leader>jh", "<cmd>MoltenHideOutput<cr>", desc = "Hide Output", icon = "🙈" },
	{
		"<leader>jv",
	...
	{ "<leader>jj", "<cmd>MoltenNext<cr>", desc = "Next Cell", icon = "⬇️" },
	{ "<leader>jk", "<cmd>MoltenPrev<cr>", desc = "Previous Cell", icon = "⬆️" },
	{ "<leader>jI", "<cmd>MoltenInterrupt<cr>", desc = "Interrupt", icon = "⏹️" },
	{ "<leader>jR", "<cmd>MoltenRestart<cr>", desc = "Restart Kernel", icon = "🔄" },
